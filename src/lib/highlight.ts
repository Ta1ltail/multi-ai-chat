...
function numbers(): TokenPattern {
  return { regex: /\b(?:0x[0-9a-fA-F_]+|0b[01_]+|\d+(?:\.\d+)?(?:[eE][+-]?\d+)?)\b/g, className: "hljs-number" };
}
...
const JS_TS_KEYWORDS = [
  ...
  // TypeScript-only
  "abstract", "any", "as", "asserts", "bigint", "boolean", "declare", "infer", "is",
  "keyof", "module", "namespace", "never", "object", "readonly", "require", "satisfies",
  "string", "symbol", "type", "unknown", "number",
];
...
const languages: Record<string, LanguageDef> = {
  ...
  python: {
    ...
    patterns: [
      ...
      kw([
        ...
        "raise", "return", "try", "while", "with", "yield", "match", "case", "print",
      ]),
      numbers(),
  ...
  html: {
    ...
    patterns: [
      ...
      { regex: /\b(doctype|html|head|body|script|style|meta|link|title)\b/g, className: "hljs-tag" },
    ],
  },
  css: {
    name: "CSS",
    patterns: [
      ...
      { regex: /\b(\d+(?:\.\d+)?(?:px|em|rem|%|vh|vw|vmin|vmax|s|ms|deg|fr|ch|ex|pt|pc|cm|mm|in)?)\b/g, className: "hljs-number" },
  ...
  bash: {
    ...
    patterns: [
      ...
      kw([
        ...
        "echo", "printf", "cd", "ls", "mkdir", "rm", "cp", "mv", "grep", "sed", "awk",
        "cat", "chmod", "chown", "sudo", "npm", "npx", "pnpm", "yarn", "bun", "git",
        "docker", "curl", "wget", "tar", "unzip", "zip", "pip", "python", "node",
        "source", "set", "shift", "alias", "test",
      ]),
  ...
  sql: {
    ...
    patterns: [
      ...
      kw([
        ...
        "JOIN", "INNER", "LEFT", "RIGHT", "OUTER", "FULL", "CROSS", "ON", "AS", "AND",
        "OR", "NOT", "NULL", "IN", "EXISTS", "BETWEEN", "LIKE", "ORDER", "BY", "GROUP",
        "HAVING", "LIMIT", "OFFSET", "DISTINCT", "COUNT", "SUM", "AVG", "MIN", "MAX",
        "PRIMARY", "FOREIGN", "KEY", "UNIQUE", "CHECK", "DEFAULT", "CONSTRAINT",
        "UNION", "ALL", "CASE", "WHEN", "THEN", "ELSE", "END", "BEGIN", "COMMIT",
        "ROLLBACK", "GRANT", "REVOKE", "TRUNCATE", "ASC", "DESC", "WITH", "RECURSIVE",
        "INT", "VARCHAR", "TEXT", "BOOLEAN", "DATE", "TIMESTAMP", "DOUBLE", "FLOAT", "DECIMAL", "BIGINT",
      ]),
      numbers(),
    ],
  },
  ...
  java: {
    ...
    patterns: [
      ...
      kw([
        ...
        "while", "var", "record", "true", "false", "null",
      ]),
      numbers(),
      upperTypes(),
      { regex: /(@[\w.]+)/g, className: "hljs-decorator" },
  ...
  cpp: {
    ...
    patterns: [
      ...
      kw([
        ...
        "volatile", "wchar_t", "while", "xor", "include", "define", "ifdef", "ifndef", "endif",
      ]),
      numbers(),
      upperTypes(),
      calls(),
  ...
  go: {
    ...
    patterns: [
      ...
      kw([
        ...
        "true", "false", "iota", "nil", "append", "len", "cap", "make", "new",
      ]),
      numbers(),
      upperTypes(),
      calls(),
...
const aliases: Record<string, string> = {
  ...
  scss: "css", less: "css", stylus: "css",
  // Shell
  sh: "bash", shell: "bash", zsh: "bash", bashrc: "bash", dockerfile: "bash",
  // Others
  sqlite: "sql", mysql: "sql", postgresql: "sql", pgsql: "sql",
  cs: "csharp", "c#": "csharp",
