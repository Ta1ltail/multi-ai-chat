    ...
    >
      {!loaded ? (
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4">
          <h2 className="mb-1.5 text-xl font-semibold tracking-tight text-foreground">How can I help you today?</h2>
          <p className="mb-8 text-sm text-foreground-tertiary">Ask me anything.</p>
          <div className="w-full max-w-2xl">
            <div className="mb-2 flex justify-center">
              <ModelSelector selectedModel={selectedModel} onSelectModel={handleSelectModel} disabled={isLoading} />
            </div>
